...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>qf", "<cmd>lua require('user.lsp.fix_current')()<CR>", opts)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>q", "<cmd>Trouble<CR>", opts)
