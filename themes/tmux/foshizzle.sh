...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=#1f2335 #${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'235'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=#7aa2f7 #${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'255'}
