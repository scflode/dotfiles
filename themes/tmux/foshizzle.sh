...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=#282b34 #${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'235'}
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=#5a6371 #${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'255'}
